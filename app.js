...
exports.create = function (opts) {
  ...
  var app = opts.app = opts.app || require('express')();
  opts.store = opts.store || require('./store').create({
    filepath: opts.filepath
  });

  return PromiseA.resolve(opts.store).then(function (DnsStore) {
    // TODO generate keyfile if it doesn't exist
    var pubPem = opts.keypair.publicKeyPem;
    var apiBase = opts.apiPrefix = opts.apiPrefix || '/api/com.daplie.ddns';
    var ANON = 'anonymous';
    var Records = { restful: {} };
    var Devices = { restful: {} };
